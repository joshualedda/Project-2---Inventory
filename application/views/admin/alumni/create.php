    ...
    <div class="main-container">
        ...
        <div class="card">
            <div class="card-header bg-white border-bottom">
                <h5 class="card-title mb-0 text-dark">Add Alumni</h5>
            </div>
            <div class="card-body">
                <form action="<?= base_url('admin/alumni/store') ?>" method="POST">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select name="student_id" class="form-select" required>
                                ...
                                <?php if (!empty($students)): foreach ($students as $s): ?>
                                    <option value="<?= $s->id ?>"><?= htmlspecialchars($s->last_name.', '.$s->first_name.' ('.$s->student_id.') - '.($s->course_name ?? 'No Course').' '.$s->year_level) ?></option>
