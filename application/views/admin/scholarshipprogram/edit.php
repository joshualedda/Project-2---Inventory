<div id="main">
    <div class="main-container">
        ...
        <h5 class="card-title mb-0">
            ...
            <div class="card-body">
                <form action="<?= base_url('admin/scholarshipprogram/update/' . $program->id) ?>" method="POST">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="scholarship_name" 
                                   value="<?= set_value('scholarship_name', $program->scholarship_name) ?>" 
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" name="description" rows="4" 
                                      placeholder="Enter program description" maxlength="200"><?= set_value('description', $program->description) ?></textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="source" 
                                   value="<?= set_value('source', $program->source) ?>" 
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="type" class="form-select">
                                ...
                                <option value="1" <?= set_select('type', '1', $program->type == 1) ?>>Academic Excellence</option>
                                <option value="2" <?= set_select('type', '2', $program->type == 2) ?>>Financial Need</option>
                                <option value="3" <?= set_select('type', '3', $program->type == 3) ?>>Athletic</option>
                                <option value="4" <?= set_select('type', '4', $program->type == 4) ?>>Cultural</option>
                                <option value="5" <?= set_select('type', '5', $program->type == 5) ?>>Merit-Based</option>
                                <option value="6" <?= set_select('type', '6', $program->type == 6) ?>>Need-Based</option>
                                <option value="7" <?= set_select('type', '7', $program->type == 7) ?>>Special Category</option>
                            </select>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary me-2">Update Program</button>
