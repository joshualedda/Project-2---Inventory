        ...
        <form action="<?= base_url('admin/student/store') ?>" method="POST">
          <div class="row g-3">
            ...
            <div class="col-md-4">
              ...
              <input type="text" class="form-control" name="guardian_name" value="<?= set_value('guardian_name') ?>">
            ...
            <div class="col-md-4">
              ...
              <input type="date" class="form-control" name="admission_date" value="<?= set_value('admission_date') ?>">
