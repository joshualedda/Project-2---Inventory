<div id="main">
    <div class="main-container">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">New Clinic Patient Record</h5>
                <form action="<?= base_url('clinic/clinic-patients/store') ?>" method="POST">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select name="student_id" class="form-select" required>
                                ...
                                <?php foreach ($students as $s): ?>
                                    <option value="<?= $s['id'] ?>" <?= set_select('student_id', $s['id']) ?>>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="weight" class="form-control" value="<?= set_value('weight') ?>" required>
                            <?= form_error('weight', '<div class="error text-danger">', '</div>') ?>
                        </div>

                        <div class="col-md-3">
                            <label class="form-label">Height (cm)</label>
                            <input type="number" name="height" class="form-control" value="<?= set_value('height') ?>" required>
                            <?= form_error('height', '<div class="error text-danger">', '</div>') ?>
                        </div>

                        <div class="col-md-3">
                            <label class="form-label">Temperature (°C)</label>
                            <input type="number" name="temperature" class="form-control" value="<?= set_value('temperature') ?>" required>
                            <?= form_error('temperature', '<div class="error text-danger">', '</div>') ?>
                        </div>

                        <div class="col-md-3">
                            <label class="form-label">Blood Pressure</label>
                            <input type="text" name="blood_pressure" class="form-control" value="<?= set_value('blood_pressure') ?>" placeholder="120/80" required>
                            <?= form_error('blood_pressure', '<div class="error text-danger">', '</div>') ?>
                        </div>

                        <div class="col-md-3">
                            <label class="form-label">Pulse</label>
                            <input type="text" name="pulse" class="form-control" value="<?= set_value('pulse') ?>" required>
                            <?= form_error('pulse', '<div class="error text-danger">', '</div>') ?>
                        </div>

                        <div class="col-md-3">
                            <label class="form-label">Respiration</label>
                            <input type="text" name="respiration" class="form-control" value="<?= set_value('respiration') ?>" required>
