<aside class="left-sidebar">
    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar>
      <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="<?= base_url('scholar/dashboard'); ?>">
  ...
  <ul id="menu-nav" class="nav-content">
    ...
    <li class="sidebar-item px-4">
      <a class="sidebar-link" href="<?= base_url('scholar/scholarships'); ?>">
    ...
    <li class="sidebar-item px-4">
      <a class="sidebar-link" href="<?= base_url('scholar/scholarshipprogram'); ?>">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="<?= base_url('scholar/profile'); ?>">
