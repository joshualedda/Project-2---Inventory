<?php
class ScholarDashboard extends MY_Controller
{
    public function index()
    {
        ...
        $data['stats'] = $this->DashboardModel->get_scholar_dashboard_stats();
        
        $this->load->view('partials/header');
        $this->load->view('partials/scholar/sidebar');
        $this->load->view('partials/scholar/navbar');
        $this->load->view('scholar/dashboard', $data);
