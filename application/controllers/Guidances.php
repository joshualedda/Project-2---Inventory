<?php
class Guidances extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/guidance/index');
    ...
    public function create()
    {
        ...
        $this->load->view('partials/sidebar');
        $this->load->view('partials/navbar');
        $this->load->view('admin/guidance/create');
        $this->load->view('partials/footer');
    }
    ...
    public function edit()
    {
        ...
        $this->load->view('partials/sidebar');
        $this->load->view('partials/navbar');
        $this->load->view('admin/guidance/edit');
        $this->load->view('partials/footer');
    }
    ...
    public function update($id)
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            // Prepare data for updating the guidance
            $data = array(
                'first_name' => $this->input->post('first_name'),
                'last_name' => $this->input->post('last_name'),
                'department_id' => $this->input->post('department_id'),
            ...
            // Update the guidance data in the database
    ...
    public function view()
    {
        ...
        $this->load->view('partials/sidebar');
        $this->load->view('partials/navbar');
        $this->load->view('admin/guidance/view');
        $this->load->view('partials/footer');
    }
}
