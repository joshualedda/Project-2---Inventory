...
class UserFiles extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('user/files/index');
    ...
    public function create()
    {
        ...
        $this->load->view('partials/user/sidebar');
        $this->load->view('partials/user/navbar');
        $this->load->view('user/files/create');
        $this->load->view('partials/footer');
    }
    ...
    public function edit()
    {
        ...
        $this->load->view('partials/user/sidebar');
        $this->load->view('partials/user/navbar');
        $this->load->view('user/files/edit');
        $this->load->view('partials/footer');
    }
    ...
    public function update($id)
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            // Prepare data for updating the files
            $data = array(
                'first_name' => $this->input->post('first_name'),
                'last_name' => $this->input->post('last_name'),
                'department_id' => $this->input->post('department_id'),
            ...
            // Update the files data in the database
    ...
    public function view()
    {
        ...
        $this->load->view('partials/user/sidebar');
        $this->load->view('partials/user/navbar');
        $this->load->view('user/files/view');
        $this->load->view('partials/footer');
    }
}
